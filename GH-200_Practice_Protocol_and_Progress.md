...
1. **Start Pass 3 — session ALREADY GENERATED: `2026-07-05-a` (56 questions, pre-built 2026-07-05, validated ALL CLEAN).** Just start presenting from Q041 onward in `sessions/2026-07-05-a/questions.md` (draws the 56 not-yet-done questions; 122 recently-correct excluded — matches `pass_progress.py --to 179`). No need to run `make_session.py` again unless you want to regenerate. **Q072 is answer-exposed** (option list seen 2026-07-04, but its answer key was never seen; the fresh shuffle re-letters it) — void or skip if in doubt when it comes up.
